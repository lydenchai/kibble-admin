        ...
        <div className="overflow-auto scroll-smooth max-h-[calc(100vh-390px)] min-h-[250px]">
          <table className="min-w-full divide-y divide-stone-100">
            <thead className="bg-stone-50/80 backdrop-blur-md sticky top-0 z-10">
              <tr>
                <th className="px-6 py-4 text-left text-xs font-black text-stone-400 uppercase tracking-widest">Staff Member</th>
                <th className="px-6 py-4 text-left text-xs font-black text-stone-400 uppercase tracking-widest">Email Address</th>
                <th className="px-6 py-4 text-left text-xs font-black text-stone-400 uppercase tracking-widest">Role / Access</th>
                <th className="px-6 py-4 text-left text-xs font-black text-stone-400 uppercase tracking-widest">Joined Date</th>
            ...
            <tbody className="bg-white/40 divide-y divide-stone-100/60">
              {loading ? (
                <tr>
                  <td colSpan={5} className="px-6 py-12 text-center text-xs text-stone-400 font-bold uppercase tracking-wider">
                  ...
                  <td colSpan={5} className="px-6 py-16 text-center text-stone-400">
                    <div className="flex flex-col items-center justify-center">
                      <div className="w-14 h-14 glass-panel bg-stone-50 rounded-3xl flex items-center justify-center mb-3 text-stone-400 border border-stone-200/80 shadow-xs">
                        <FiUserPlus className="w-6 h-6 text-stone-400" />
                      </div>
                      <p className="text-base font-black text-stone-900">No staff members found</p>
                      <p className="text-xs text-stone-400 mt-0.5 font-medium">Click "Add Staff Member" to invite staff.</p>
                    </div>
                  </td>
                </tr>
              ) : (
                staffList.map((member) => (
                  <tr key={member._id} className="hover:bg-amber-50/30 transition-colors">
